...
public class MPView extends application.BCompPanel {
    ...
    public MPView(GUI gui) {
        ...
        checkBoxPanel.setBackground(new Color(219, 249, 235));
...
//        regField.setSize(200, 100);
        ...
        checkBoxPanel.add(mpSubmitButton, BorderLayout.SOUTH);
        cucheckbox.setPreferredSize(new Dimension(210, 50));
        checkBoxPanel.add(cucheckbox, BorderLayout.EAST);
